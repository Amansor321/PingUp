...
const Connections = () => {
  ...
  const handleUnFollow= async (userId)=>{
   ...
   const accepttConnection= async (userId)=>{
    try {
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8 flex flex-wrap gap-6">
          {dataArray.map((item, index) => (
            <div
              key={index}
              className="flex flex-col items-center justify-center gap-1 border h-20 w-40 border-gary-200 bg-white shadow rounded-md"
            >
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    ...
                    {currentTab === "Pending" && (
                      <button onClick={()=> accepttConnection(user._id)} className="w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-black active:scale-95 transition cursor-pointer">
                        Accept
                      </button>
                    )}

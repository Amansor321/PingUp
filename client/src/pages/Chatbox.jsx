      ...
      <div className="flex flex-col h-screen">
          ...
          <div className="space-y-4 max-w-4xl mx-auto">
            {messages
              ...
              .map((message, index) => (
                ...
                >
                  <div className={`p-2 text-sm max-w-sm bg-white text-slate-700 rounded-lg shadow ${message.to_user !== user._id ? 'rounded-bl-none' : 'rounded-br-none' }`} >
        ...
        <div className="px-4" >
          <div className="flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5" >
            ...
            <button onClick={sendMessage} className="bg-gradient-to-br from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95 cursor-pointer text-white p-2 rounded-full" ><SendHorizontal size={18} /></button>
